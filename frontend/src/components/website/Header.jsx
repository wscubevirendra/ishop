            ...
            <div className="max-w-7xl mx-auto px-7 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                    <div className="hidden md:block text-right">
                        ...
                        {
                            user ?
                                <Link href="/profile" className="font-semibold text-sm">{user.name}</Link>
                                :
                    ...
                    <Link href="/cart">
                        <div className="relative flex items-center gap-2 cursor-pointer">
                            ...
                            <span className="hidden md:block font-semibold">{formatIndianCurrency(cart?.final_total || 0)}</span>
                        </div></Link>
